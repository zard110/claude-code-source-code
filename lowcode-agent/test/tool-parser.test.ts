...
import { extractToolCalls, cleanToolTags } from '../src/agent/tool-parser.js'

describe('extractToolCalls (tool-parser)', () => {
  it('提取单个工具调用', () => {
...
describe('cleanToolTags (tool-parser)', () => {
  it('删除单个工具标签', () => {
